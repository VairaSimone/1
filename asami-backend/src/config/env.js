...
const Env = z.object({
  ...
  RETENTION_NEED_HISTORY_DAYS: z.coerce.number().int().min(1).default(7),
  RETENTION_EMOTION_HISTORY_DAYS: z.coerce.number().int().min(1).default(7),
  ...
  RETENTION_MEMORY_ARCHIVE_DAYS: z.coerce.number().int().min(7).default(30),

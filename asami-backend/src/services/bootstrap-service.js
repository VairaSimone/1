...
const RELATIONSHIPS=[["PARENT","Parent",0],["CHILD","Child",0],["SIBLING","Sibling",1],["FRIEND","Friend",1],["ACQUAINTANCE","Acquaintance",1],["TEACHER","Teacher",0],["STUDENT","Student",0],["CAREGIVER","Caregiver",0],["EMPLOYER","Employer",0],["COLLEAGUE","Colleague",1],["PARTNER","Partner",1]];
// development_stages stores simulated age in days. Keep the catalog aligned with behavioral-policy-bootstrap.
const DAY_PER_YEAR=365.25;
const DEVELOPMENT_STAGES=[["NEWBORN","Newborn",0,0.5],["INFANT","Infant",0.5,2*DAY_PER_YEAR],["TODDLER","Toddler",2*DAY_PER_YEAR,5*DAY_PER_YEAR],["CHILD","Child",5*DAY_PER_YEAR,13*DAY_PER_YEAR],["ADOLESCENT","Adolescent",13*DAY_PER_YEAR,18*DAY_PER_YEAR],["YOUNG_ADULT","Young Adult",18*DAY_PER_YEAR,30*DAY_PER_YEAR],["ADULT","Adult",30*DAY_PER_YEAR,65*DAY_PER_YEAR],["ELDER","Elder",65*DAY_PER_YEAR,null]];
